  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        {/* List Per Poin (Mobile: Horizontal Center / Desktop: Zig-Zag Center) */}
        <div className="space-y-16 md:space-y-24">
          {NOW_FOCUS_TEXT.items.map((item, index) => {
            const isEven = index % 2 === 1; // Genap (poin 2) -> Angka Kiri, Teks Kanan di Desktop
            const numberDisplay = index + 1; // 1, 2, 3
            ...
            return (
              ...
              >
                ...
                {/* Blok Angka Raksasa dengan Photo Masking (Vertically Centered) */}
                <div 
                ...
                >
                  <span 
                    className="font-mono text-6xl sm:text-8xl md:text-9xl lg:text-[13rem] font-black leading-none text-transparent bg-clip-text bg-cover bg-center filter grayscale brightness-90 contrast-[130%] group-hover:grayscale-0 group-hover:brightness-100 group-hover:scale-105 transition-all duration-700 ease-out select-none block"
